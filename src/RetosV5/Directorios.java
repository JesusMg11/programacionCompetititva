...
public class Directorios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingresa el nombre del directorio");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this,"ERROR: NO PUEDES CREAR UN DIRECTORIO VACÍO");
        }else{
        File directorio=new File("c:/users/JorgeFrancisco/desktop/"+jTextField1.getText());
        directorio.mkdir();
